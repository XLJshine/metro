...
@property (nonatomic, weak) AFURLSessionManagerPanChan *manager;
...
#pragma clang diagnostic ignored "-Wgnu"
    __strong AFURLSessionManagerPanChan *manager = self.manager;
...
@interface AFURLSessionManagerPanChan ()
...
@implementation AFURLSessionManagerPanChan
...
- (void)setResponseSerializer:(id <AFURLResponseSerializationPanChan>)responseSerializer {

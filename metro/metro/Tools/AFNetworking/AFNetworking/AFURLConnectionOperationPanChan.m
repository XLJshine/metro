...
@implementation AFURLConnectionOperationPanChan
                      ...
                      completionBlock:(void (^)(NSArray *operations))completionBlock
{
    ...
    for (AFURLConnectionOperationPanChan *operation in operations) {
...
- (id)copyWithZone:(NSZone *)zone {
    AFURLConnectionOperationPanChan *operation = [(AFURLConnectionOperationPanChan *)[[self class] allocWithZone:zone] initWithRequest:self.request];

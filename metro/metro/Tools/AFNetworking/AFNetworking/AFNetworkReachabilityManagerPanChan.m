...
@interface AFNetworkReachabilityManagerPanChan ()
...
@implementation AFNetworkReachabilityManagerPanChan

+ (instancetype)sharedManager {
    static AFNetworkReachabilityManagerPanChan *_sharedManager = nil;
...
+ (instancetype)managerForDomain:(NSString *)domain {
    ...
    AFNetworkReachabilityManagerPanChan *manager = [[self alloc] initWithReachability:reachability];

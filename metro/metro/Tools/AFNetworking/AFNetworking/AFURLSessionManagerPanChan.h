...
@interface AFURLSessionManagerPanChan : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
...
@property (nonatomic, strong) id <AFURLResponseSerializationPanChan> responseSerializer;

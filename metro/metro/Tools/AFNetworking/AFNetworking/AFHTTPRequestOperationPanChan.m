...
@interface AFURLConnectionOperationPanChan ()
@property (readwrite, nonatomic, strong) NSURLRequest *request;
@property (readwrite, nonatomic, strong) NSURLResponse *response;
@end

@interface AFHTTPRequestOperationPanChan ()
...
@implementation AFHTTPRequestOperationPanChan
@dynamic lock;
...
- (instancetype)initWithRequest:(NSURLRequest *)urlRequest {
    ...
    self.responseSerializer = [AFHTTPResponseSerializerPanChan serializer];
...
#pragma mark - AFHTTPRequestOperationPanChan
...
- (id)copyWithZone:(NSZone *)zone {
    AFHTTPRequestOperationPanChan *operation = [super copyWithZone:zone];

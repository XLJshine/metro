...
@interface AFHTTPSessionManagerPanChan ()
@property (readwrite, nonatomic, strong) NSURL *baseURL;
@end

@implementation AFHTTPSessionManagerPanChan
...
- (id)copyWithZone:(NSZone *)zone {
    AFHTTPSessionManagerPanChan *HTTPClient = [[[self class] allocWithZone:zone] initWithBaseURL:self.baseURL sessionConfiguration:self.session.configuration];
